...
\relative c{
  ...
  <<
    \relative c{
       \slap \stemDown \tuplet 3/2{b''16-.^\markup{\teeny {"tongue ram (ricochet effect)"}} 16-. 16-.} \stemNeutral \hide NoteHead cs,16_>_.[ cs16_-]\downbow cs8 b'8_-\upbow
      %m14
  ...
  %m16
  \startStaff
  r4 r16 \uN d'8._-\-\upbow\f_\markup{\line{"[F]"}\draw-line#'(10 . 0)}
  %m17
  ...
  <<
    \relative c{
      \hide NoteHead r8[ r16 \uN a''16_-\upbow] \tuplet 3/2{a8 c,4:32_-\downbow}
      %m29
      c16:32[ g'16\rest g8\rest]
    }
    \\
    \relative c{
      s8. \hide Stem \uN a''16\f\-_\markup{\line{"[F]"}\draw-line#'(2.5 . 0)} \omit TupletNumber \tuplet 3/2{ s8 \lineDashed c,4\-_\markup{\line{"[R]"}\draw-line#'(15 . 0)}}
      %m29
  ...
  \sharpDown \dalniente \noireNH ds4\-\< r4\fff 
  %34 
  r16[ \dalniente \uN fs,8.\-\<]\downbow_\markup{\line{"[F]"}\draw-line#'(8 . 0)} r4\f \stopStaff 
  s2*2 \startStaff 
  %37
  \sharpUp \dalniente  \noireNH fs4\-\< r4\fff
  \stopStaff 
  ...
  <<
    \relative c{
      \hide NoteHead \uN \tuplet 3/2{g''8\rest[ g8\rest b8_-\upbow]} 16 d,8._-\downbow
      %46
      8 cs8:32_-\downbow 8.:32 fs16_-\upbow
      %47
      f8[ g\rest] g8\rest[ d8:32_-\downbow]
      %48
      16[ g8.\rest] g8.\rest[
      \noireNH \naturalUp f16]
      %49
    ...
    \relative c{
      ...
      %46
      s8 \lineDashed cs8\-_\markup{\line{"[R]"}\draw-line#'(10 . 0)} s8. fs16\-_\markup{\line{"[F]"}\draw-line#'(8 . 0)}
      %47
      s8 g\rest g\rest \lineDashed d8\-_\markup{\line{"[R]"}\draw-line#'(10 . 0)}
      %48
  ...
  r16 \tuplet 3/2{ \slap d16-.\f\>( d16-. d16-.)} r16\! r16[ \uN \dalniente a'8.--\-\<\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]
  %53
  ...
  %75
  \startStaff
  \uN b4--\-\upbow\f_\markup{\line{"[S]"}\draw-line#'(9 . 0)} r4
  \stopStaff
  %m76
  s2
  %77
  \startStaff
  <<
    \relative c{\hide NoteHead \uN g''8\rest[ d8:32_-\upbow] 16[ b'8_-\upbow c16\rest]}
    \\
    \relative c{\hide Stem \uN g''8\rest \lineDashed d\-_\markup{\line{"[R]"}\draw-line#'(5 . 0)} s16 b'8\-_\markup{\line{"[S]"}\draw-line#'(3 . 0)} c16\rest }
  >>
  %78
  r4 r16[ a8.--\-\upbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]
  %79
  \tuplet 3/2 {c,4_-\-\downbow_\markup{\line{"[g]"}\draw-line#'(3 . 0)} r8} r4
  %80
  r16 \tuplet 3/2 {\slap ds16\mf\>-.( 16-. 16-.)} r16\!
  <<
    \relative c{
      \hide NoteHead \uN g''8\rest[ b8_-\upbow]
      %81
      16[ g8\rest s16]
    }
    \\
    \relative c{
      \hide Stem \uN g''8\rest b\f\-_\markup{\line{"[S]"}\draw-line#'(5 . 0)}
      s16 g8.\rest
    }
  >>
  r4
  ...
  %84
  \startStaff
  \uN \lineDashed fs8.:32_-\downbow\mf\-_\markup{\line{"[R]"}\draw-line#'(8 . 0)}[ r16] r4
  %85
  \noireNH \lineDashed a''8:32--\-\flageolet\mp[ r8] r4
  %86
  r4 <<
    \relative c{
      \hide NoteHead \uN \tuplet 3/2{d''8\rest[ d\rest b8_-\upbow]}
      %87
      16[ d,8.:64]_-\downbow
    }
    \\
    %86
    \relative c{
      \hide Stem \uN \omit TupletNumber \omit TupletBracket \tuplet 3/2{d''8\rest d\rest b8\-\mf_\markup{\line{"[F]"}\draw-line#'(6 . 0)}}
      %87
      s16 d,8.\-_\markup{\line{"[R]"}\draw-line#'(5 . 0)}
    }
  >> r4
  %88
  r16 \tuplet 3/2{\xH r16[ c,,,16-.\f gs'-.] } r16 r4 \stopStaff
  %89
  s2*6  \mark "E1"
  \startStaff <<\relative c'{d'8\rest \hide NoteHead \stemDown b''8\flageolet 8\flageolet[ d,,8\rest]}
                \\
                \relative c'{s8 \hide Stem b'''8\mf\- s8 d,,8\rest}>> \stopStaff
  s2 \startStaff
  r4 r16[ \lineDashed \uN a8.\f--\downbow\-_\markup{\line{"[R]"}\draw-line#'(5 . 0)}] \stopStaff
  ...
  r4 r8. <<
    \relative c{
      \hide NoteHead \stemNeutral \uN b''16--_\markup{\line{"[sh]"}\draw-line #'(5 . 0)}  %m3
      16 cs,8._---_\markup{\line{"[F]"}\draw-line #'(8 . 0)} 16[ e8.\rest] s4. f8\downbow_-_\markup{\line{"[F]"}\draw-line #'(22 . 0)} 
      4 16[ g8.\rest]
    } %m4
    \\
    \relative c{
      \hide Stem \uN b''16\f\- ^\upbow %m3
      s16 cs,8.\- ^\downbow s16 e8\rest s16 g4\rest g8\rest[ fs8\f\-] %m4
      s4 s16 g8\rest s16
    }
  >>
  r16[ \noireNH \dalniente c8.--\p\>->] \glissando \glissandoSkipOn b8[ \glissandoSkipOff \undo \hide NoteHead \naturalDown \magnifyMusic 0.5 {a!16\!} r16] %m5
  ...
  <<
    ...
    \\
    \relative c{\hide Stem \blancheNH \lineDashed <c''! cs>2--\-\p\- s4 g\rest}
  >>
  ...
  <<
    \relative c{
      g''8\rest \hide NoteHead \stemDown \noireNH \naturalUp b'!8\p 4
      %126
      8.[ g16\rest]
    }
    \\
  ...
  <<
    \relative c{
      \hide NoteHead \uN \tuplet 3/2{g''8\rest cs,4_-\downbow}
      %134
      c16[ a'8.\upbow_-] 16[ g8.\rest]
    }
    \\
    \relative c{
      \hide Stem \uN \omit TupletBracket \omit TupletNumber \tuplet 3/2{g''8\rest cs,4\-_\markup{\line{"[F]"}\draw-line#'(7 . 0)}}
      %134
      s16 a'8.\-_\markup{\line{"[S]"}\draw-line#'(7 . 0)} s16 g8\rest s16
    }
  >>
  %135
  ...
  <<\relative c'{\stemDown \hide NoteHead 
    <c'' cs>2:32-- c2:32}
    \\
    \relative c'{\hide Stem \lineDashed \blancheNH <c''! cs>2\mp\- s2}>> \stopStaff
  %143-159
  s2*15 \mark H
  s2*2
  %160
  ...
  %170
  r4 \uN \lineDashed b,,8:32--\-\downbow\f_\markup{\line{"[R]"}\draw-line#'(5 . 0)}[ r8]
  %171
  r4 \noireNH a''8--\-\ppp\flageolet[ r8]
  %172-173
  r4 <<
    \relative c{\hide NoteHead \uN ds'4:32_-\upbow\f_\markup{\line{"[R]"}\draw-line#'(13 . 0)} d16:32[ a'8._-\downbow_\markup{\line{"[F]"}\draw-line#'(8 . 0)}]}
    \\
  ...
  \startStaff
  <<
    \relative c{\hide NoteHead \blancheNH \stemDown <c'' cs>2:32-- c2:32 2:32 16:64[ g16\rest] \uN \stemUp  d8_-\f\upbow_\markup{\line{"[sh]"}\draw-line#'(3 . 0)}}
    \\
  ...
  <<
    \relative c{ \xH e'16_. \hide NoteHead \uN d16\f\upbow_-_\markup{\line{"[F]"}\draw-line#'(17 . 0)} 4 e16.[ g32\rest r8]}
    \\
    \relative c{\hide Stem \uN s16 d'16\- s4 s16 s32 g32\rest s8 }
  >>
  r4
  %186
  r8[ \dalniente \sharpUp \noireNH fs''8\mp--\>] \glissando \glissandoSkipOn f!16[ \glissandoSkipOff \undo \hide NoteHead \magnifyMusic 0.5 {e16\!} r8]
  %187-188
 
  r4 <<
    \relative c{\hide NoteHead \uN r8[ f'8_-\upbow\f_\markup{\line{"[g]"}\draw-line#'(10 . 0)}] 16[ g\rest r8]}
    \\
  ...
  %190-191
  <<
    \relative c{\hide NoteHead \uN r16[ e'8:32_-\upbow_\markup{\line{"[R]"}\draw-line#'(2 . 0)} c16_-\downbow_\markup{\line{"[g]"}\draw-line#'(7 . 0)}] 8. bf'16_-\upbow_\markup{\line{"[sh]"}\draw-line#'(1.5 . 0)} b8.[ g16\rest]}
    \\
    \relative c{\hide Stem \uN s16 \lineDashed e'8\- c16\- s8. bf'16\- s8. g16\rest}
  >> r4
  ...
  r4 r8 \tuplet 3/2{\dalniente \uN cs,16:64\<( ds16:64 f!16:64}
  \tuplet 3/2{\dalniente g16:64\f\> a16:64 b16:64)} r8\! r4
  \stopStaff
  s2*7 \mark K
  ...
  \startStaff
  <<
    \relative c{\hide NoteHead \uN g''8.\rest[ a16:32_-\downbow\f_\markup{\line{"[R]"}\draw-line#'(6 . 0)}] a8:32[ g8\rest]}
    \\
  ...
  \startStaff
  <<
    \relative c{\hide NoteHead \uN a''4_-\upbow\f_\markup{\line{"[g]"}\draw-line#'(13 . 0)} 16.[ g32\rest g8\rest] }
    \\
  ...
  %240
  r4 <<
    \relative c{g''8\rest[ \hide NoteHead \uN f8_-\f\upbow_\markup{\line{"[g]"}\draw-line#'(5 . 0)}] 8[ g\rest]}
    \\
    \relative c{\hide Stem s8 \uN f'8\- s8 g\rest}
  >> r4
  \stopStaff
  %241
  s2*6 \mark "M"
  ...
  %248
  \startStaff
  r4 r8 \tuplet 3/2{\xH d,16->-.\f( b' a)}
  \uN a8_-\upbow\-_\markup{\line{"[F]"}\draw-line#'(5 . 0)}\mf \xH \tuplet 3/2{f16->-.\f e-.-> d-.->} \uN \lineDashed d4:32_-\-\downbow_\markup{\line{"[R]"}\draw-line#'(5 . 0)}
  %251
  \stopStaff \hide Rest r2
  \startStaff
  \undo \hide Rest
  ...
  <<
    \relative c{
      g''16\rest[ \hide NoteHead \xH c,32_>_.\f \uN b'32_-\upbow\p_\markup{\line{"[F]"}\draw-line#'(10 . 0)} 8] \tuplet 5/4{8.[ cs,8_-_\markup{\line{"[g]"}\draw-line#'(9 . 0)}]\downbow}
      %258
      c16[ g'8.\rest]
    }
    \\
  ...
  <<
    \relative c{
      g''16.\rest[ \uN \hide NoteHead \stemUp c,32:64_-\fff\upbow_\markup{\line{"[R]"}\draw-line#'(10 . 0)} c8:32] 16:32[ g'8.\rest]
      %262
    ...
    %261
    \relative c{
      g''16\rest s32 \hide Stem \uN \lineDashed c,32\- s8 s16 g'8\rest s16
      %262
  ...
  %273
  \startStaff
  \tuplet 3/2{\uN \lineDashed cs8:32\fff--\-[_\markup{\line{"[R]"}\draw-line#'(1.5 . 0)}\downbow r8 r8]} r4
  r4 r16[ \naturalUp \noireNH  f''!8.--\-\p]
  ...
  <<
    \relative c'{\hide NoteHead \uN g'8\rest[ f8:32\downbow_-_\markup{\line{"[R]"}\draw-line#'(9 . 0)}] 16[ g8.\rest]}
    \\
  ...
  \startStaff
  \uN  d,8\upbow--_\markup{\line{"[F]"}\draw-line#'(3 . 0)}\mf\-[ r8] r4
  r4 b'8.--\upbow_\markup{\line{"[S]"}\draw-line#'(8 . 0)}\-[ r16]
  r4 r8 \tuplet 3/2{\slap fs16-.\p\> fs16-. fs16-.\!}
  r4 <<
    \relative c'{\hide NoteHead \uN \tuplet 3/2{  g'8\rest a4_-\downbow\mp_\markup{\line{"[R]"}\draw-line#'(12 . 0)}} 8 d,8:32\upbow_-_\markup{\line{"[R]"}\draw-line#'(5 . 0)}}
    \\
    \relative c'{\hide Stem \omit TupletBracket \omit TupletNumber \tuplet 3/2{ s8 \uN a'4\-} s8 \lineDashed d,8\-}
  >>
  r4
  \stopStaff
  s2*9 \mark "P"
  \startStaff 
  r4 <<\relative c'{ \hide NoteHead \stemNeutral b'8\rest[ \sharpUp \dalniente fs'8\<]
                     \dalniente f8\mf\>[ b,8\rest\!]}
       \\
       \relative c'{\hide Stem \stemDown s8 \sharpUp fs'8\- s8 b,8\rest}>> r4
  \stopStaff
  s2*15
  %316 [13]
  \startStaff
  ...
  <<
    ...
    \\
    \relative c'{
      \hide Stem \uN cs4\- s16 b'8.\- g4\rest
      \stopStaff s2
  ...
  <<
    \relative c'{
      \hide NoteHead \uN \tuplet 5/4{g'16\rest[ g16\rest g16\rest fs8_-\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]} \tuplet 5/4{16[ g16\rest g16\rest d8]_-\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}}
    ...
    \\
    \relative c'{
      \hide Stem \uN \omit TupletBracket \omit TupletNumber \tuplet 5/4{s8. \uN fs8\-} \omit TupletBracket \omit TupletNumber \tuplet 5/4{s16 g16\rest g16\rest d8\-}
  ...
  r4 <<
    \relative c'{
      ...
      c16[ d,8:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(5 . 0)} g16\rest] \tuplet 5/4{g16\rest[ g16\rest g16\rest fs8]_\markup{\line{"[F]"}\draw-line#'(10 . 0)}}_-\downbow
  ...
  %370
  \noireNH a'''8.--\-\flageolet\mp[ r16] r8[ \uN b,,8--\-\upbow\f_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]
  ...
  <<
    ...
    \\
    \relative c'{
      \hide Stem \uN \omit TupletBracket \omit TupletNumber \tuplet 3/2{ s8 cs'4\-} s16 cs,8.\-
  ...
  >>
  \stopStaff s2
  \startStaff r4 \noireNH \dalniente a8..\mp\>->\glissando\flageolet \magnifyMusic0.5{gs32\flageolet\!}
  r4 <b,! cs>4--\-\mp
  ...
  <<
    \relative c'{
      \hide NoteHead \stemDown b'8\rest[ \noireNH a'8:32--\p]
      8:32[ g,8\rest]
    }
    \\
    \relative c'{\hide Stem b'8\rest \lineDashed a'8\- s8 g,8\rest}
  >> r4
  %389 
  \stopStaff
  s2*19 %{
  ...
  <<
    \relative c''{
      \stemDown \hide NoteHead b4\rest b8\rest[ b16\rest \naturalUp b'!16]
  ...
  \startStaff \mark "R1"
  <<
    \relative c'{\hide NoteHead \uN cs4:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(20 . 0)} b4:32}
    \\
    \relative c'{\hide Stem \uN \lineDashed cs4\-\fffff s4}
  >> \stopStaff s2 %409
  \startStaff r4
    <<\relative c'{\hide NoteHead \uN b'4:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(10 . 0)} b8.:32[ b16\rest]}
    \\
    \relative c'{\hide Stem \uN \lineDashed b'4\-\fffff s8 s16  b16\rest}>>  r4
    \stopStaff
  ...
  <<
    \relative c'{
      \hide NoteHead b'4\rest \stemDown \naturalUp b'!4
  ...
  \stopStaff
  s2*4 \startStaff 
  \sharpDown \dalniente \noireNH fs''4--\mp\> \glissando \magnifyMusic 0.5 {e32\!} r32 r8. 
  <<\relative c'{\hide NoteHead 
    b'8\rest[ \uN fs8]_-\downbow_\markup{\line{"[g]"}\draw-line#'(13 . 0)} 4
    f4 8.[ b16\rest]}
    \\
    \relative c'{\hide Stem 
  s8 \uN fs8\-\f s2 
