...
\relative c' {
    ...
    s2*6 %\break
    \startStaff
    \noireNH <e fs c''>16\-\ppp[ r16 <e fs c''>16\- r16] r4 
    ...
    %m23
    \startStaff
    <<\relative c{\hide NoteHead \uN fs'4_-\downbow^\markup{\teeny{"exhale"}}_\markup{\line{"[F]"}\draw-line#'(27 . 0)} 4 f16[ g8.\rest]}
    \\
    ...
    %m28
    \startStaff 
    \uN f'8._-[\downbow\-_\markup{\line{"[F]"}\draw-line#'(5 . 0)} r16] r4 
    %m29
     <<\relative c{\hide NoteHead \uN a''8._-\upbow^\markup{\teeny{"inhale"}}[ cs,16_-]\downbow 8[ d8\rest]} 
    \\
    ...
    %32
    \startStaff
    r4 r16[ cs,8.]_-\-_\markup{\line{"[g]"}\draw-line#'(7 . 0)}\downbow
    %33
    b'4--\upbow\-_\markup{\line{"[sh]"}\draw-line#'(9 . 0)} r4 
    r4 <<\relative c'{b'16\rest[ \hide NoteHead \uN b8._-\downbow_\markup{\line{"[s]"}\draw-line#'(35 . 0)}]
         4 4
         4 4
         4 b4\rest}
         \\
    ...
    <<\relative c{g''8.\rest[ \hide NoteHead \uN b16_-\upbow]
    %46
    8. cs,16_-\downbow 8.[ g'16\rest] 
    %47
    g8\rest[ g32\rest b16._-\upbow] 8.[ g16\rest]
    %48
    g8.\rest[ d16_-\downbow] 8.[ g16\rest] }
    \\
    %45 (final part of the measure)
    \relative c{g''8\rest s16 \hide Stem \uN b16\-_\markup{\line{"[s]"}\draw-line#'(3 . 0)}
    %46
    s8. cs,16\-_\markup{\line{"[F]"}\draw-line#'(9 . 0)} s8. g'16\rest
    %m47
    g8\rest s32 b16.\-_\markup{\line{"[g]"}\draw-line#'(8 . 0)} s8. g16\rest
    %48
    g8\rest s16 d16\-_\markup{\line{"[F]"}\draw-line#'(8 . 0)} s8. g16\rest
    }>>
    %m49
    \stopStaff
    s2 %\break
    ...
    %m51
    <<\relative c{ \hide NoteHead \uN \stemDown d''4--\upbow \stemNeutral 16 d,8._-\downbow
    %52
    8[ g\rest]}
    \\
    %m51
    \relative c{\hide Stem \uN d''4\-_\markup{\line{"[S]"}\draw-line#'(10 . 0)} s16 d,8.\-_\markup{\line{"[F]"}\draw-line#'(15 . 0)}
    %52
    s8 g\rest}>>
    r4 \stopStaff
    %53-54
    ...
    %55
    \startStaff
    <<\relative c{g''8\rest[ \hide NoteHead \uN a8_-\upbow] 8 32 b,16.\downbow_-
    %56
    8[ g'\rest]}
    \\
    %55
    ...
    %65 D
    \startStaff r4 r32 \noireNH fs8.--\p\glissando \magnifyMusic 0.5 {f!32}
    \stopStaff 
    %59
    ...
    \startStaff
    %75
    \uN a4--\f\downbow\-_\markup{\line{"[S]"}\draw-line#'(8 . 0)} r4
    %76
    r4
    <<\relative c{\hide NoteHead \uN cs'8._-\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)} b'16_-\downbow_\markup{\line{"[g]"}\draw-line#'(11 . 0)}
    %77
    ...
    r4
    %78
    <<\relative c{\hide NoteHead \uN f'8._-\f\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)} d16_-\upbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}
    8 g\rest
    %79
    \stemDown g\rest b8--\upbow_\markup{\line{"[S]"}\draw-line#'(8 . 0)} 8 g\rest}
    \\
    %78
    ...
    %81
    \startStaff
    <<\relative c{\hide NoteHead \uN d'4\downbow_\markup{\line{"[F]"}\draw-line#'(73 . 0)} 4
    %82
    4 4
    %83
    \uN 4 8[  b'8_-]\upbow_\markup{\line{"[g]"}\draw-line#'(10 . 0)}
    %84
    \stemDown 16[ g8.\rest]}
    \\
    %81
    \relative c{\uN \hide Stem \stemUp d'4--\- s4 
    %82
    s4 s4
    %83
    \uN s4. b'8\-
    ...
    %86
    \startStaff
    <<\relative c{g''8\rest \hide NoteHead \uN d8_-\downbow_\markup{\line{"[g]"}\draw-line#'(8 . 0)} 16
    b'8._-\upbow_\markup{\line{"[F]"}\draw-line#'(25 . 0)} 4 16[ g16\rest g8\rest]}
    \\
    ...
    s2
    \startStaff
    <<\relative c'{\hide NoteHead \uN cs4_-_\markup{\line{"[F]"}\draw-line#'(108 . 0)}\mp\downbow 4 c4 4 %m2
    c4 4 4 8.[ e16\rest]}
    \\
    \relative c'{\uN cs1\- 
    s2... e16\rest}>>
    \stopStaff s2*2  %m4 
    \startStaff r4 \uN cs8._-\-[\downbow_\markup{\line{"[g]"}\draw-line #'(5 . 0)}   r16] 
    \stopStaff 
    s2
    \startStaff %m5
    << \relative c{ b''4\rest r8[ \hide NoteHead \uN f8_-] 4 4 %m6
    4 4 4 4} %m7
    \\
    \relative c{s4 \hide Stem s8 \uN f'8\-_\markup{\line{"[F]"}\draw-line #'(27 . 0)}^\downbow  s4 s4 %m6
    s1 
    \stopStaff
    ...
    %133
    \startStaff
    <<\relative c{\hide NoteHead \uN fs'4_-\downbow_\markup{\line{"[F]"}\draw-line#'(10 . 0)} 16[ a8._-\upbow_\markup{\line{"[g]"}\draw-line#'(7 . 0)} ]}
    \\
    ...
    %136
    <<\relative c{\hide NoteHead \uN b'4_-\downbow_\markup{\line{"[g]"}\draw-line#'(12 . 0)} \tuplet 3/2{8 a'4_\markup{\line{"[F]"}\draw-line#'(5 . 0)}_-\upbow}}
    \\
    ...
    \startStaff
    \undo \hide Rest
    \lineDashed \uNw b,2:32--\downbow\-\f_\markup{\line{"[R]"}\draw-line#'(20 . 0)}
    %139
    \stopStaff \hide Rest r2 \undo \hide Rest s2 \startStaff
    <<\relative c'{\hide NoteHead 
                   \uNw a'2:32\downbow_-_\markup{\line{"[R]"}\draw-line#'(50 . 0)} a2:32}
      \\
      \relative c'{\hide Stem \uNw \lineDashed a'2\- s2}>> \stopStaff
    %143
    s2*17
    %160
    \startStaff
    %\undo \hide Rest
    <<\relative c{d'8\rest[ d32\rest \hide NoteHead \uN c16.\upbow_\markup{\line{"[F]"}\draw-line#'(3.5 . 0)}] 32[ d8..\rest]^\markup{\teeny \box \bold{"reed ON"}}}
    \\
    ...
    \startStaff
    \undo \hide Rest
    <e fs c''>16\ppp--\-[ r16 r16 aqs16--\-] r4
    %183
    ...
    \startStaff
    %185
    r4 <<\relative c'{\stemDown \hide NoteHead <d' a'>--\ppp\flageolet 4}
    \\
    \relative c'{\hide Stem <d' a'>4\- s4}>>
    %186 2nd half of the measure
    r4 
    %187
    \stopStaff s2
    %188
    ...
    %220
    \startStaff
    <<\relative c{\hide NoteHead \noireNH  r8.[ \sharpDown fs'16_-\p] 8[ g\rest] aqs4_-\p 4 a16[ g8.\rest]}
    \\
    ...
    \\
    \relative c{s8 \hide Stem \sharpUp \stemUp cs'8--\- s1 s16 d8\rest s16}>>
    r4^\markup{\teeny \box \bold{"reed OFF"}}
    %240
    r4 <<\relative c{g''8.\rest[ \hide NoteHead \uN a16_-\downbow_\markup{\line{"[F]"}\draw-line#'(4 . 0)}] 8[ g\rest]}
    \\
    ...
    r4 <<\relative c{\hide NoteHead 
                     \uN 
                     \tuplet 5/4{g''8\rest[ g16\rest a8_-\upbow]} 8. fs16:64_-_\markup{\line{"[F]"}\draw-line#'(5 . 0)}\downbow 16 d16\rest d16\rest \undo \hide NoteHead \tuplet 3/2{\slap d16_.\f e_. fs_.} \hide NoteHead \uN cs8._-_\markup{\line{"[g]"}\draw-line#'(10 . 0)}\downbow}
    \\
    \relative c{\hide Stem 
                \uN 
                \omit TupletBracket 
                \omit TupletNumber 
                \tuplet 5/4{ g''8\rest g16\rest a8\-_\markup{\line{"[S]"}\draw-line#'(13 . 0)}} 
                s8. fs16--\- s16 d16\rest d16\rest s8 cs8.\- }>> r4 \pageBreak
    %260
    \stopStaff s2*2
    \startStaff %262
    <<\relative c{ \repeat unfold 2{ \hide NoteHead d'8\rest[ \uN cs8_-\downbow_\markup{\line{"[S]"}\draw-line#'(8 . 0)}]}}
    \\
    \relative c{\repeat unfold 2{\hide Stem \uN d'8\rest cs8\-}}>>
    %263
    <<\relative c{d'8.\rest[ cs16_-\downbow_\markup{\line{"[S]"}\draw-line#'(8 . 0)}] 16[ d8.\rest]}
    \\
    ...
    %270
    \startStaff
    \uN cs8\fff--\-\upbow_\markup{\line{"[S]"}\draw-line#'(3 . 0)}[ r8] r4
    <<\relative c'{\hide NoteHead \uN g'8.\rest[ a16_-\downbow_\markup{\line{"[g]"}\draw-line#'(14 . 0)}] 4 
    g4\rest g8.\rest[ f16_-\downbow_\markup{\line{"[F]"}\draw-line#'(8 . 0)}]
    \tuplet 3/2{8 a4\upbow_-_\markup{\line{"[sh]"}\draw-line#'(5 . 0)}}} 
    \\
    ...
    s2 \startStaff
     <<\relative c'{\hide NoteHead \uN
        g'16\rest[ d8.\downbow_-]_\markup{\line{"[g]"}\draw-line#'(11 . 0)}
       8[ g8\rest]}
         \\
    ...
    %281
    \startStaff \uNw f2--_\markup{\line{"[g]"}\draw-line#'(23 . 0)}\-\downbow
    \stopStaff \hide Rest r2
    s2 \startStaff \undo \hide Rest 
    \uN \dalniente d32\<_\markup{\line{"[F]"}\draw-line#'(15 . 0)}(ds e f fs g gs a\f) r4 
   % \startStaff
    \undo \hide Rest
    ...
    r4 \tuplet 5/4{\slap d,16-.\p\> e-. fs-. gs-. as-.}
    r4\! <<\relative c'{\hide NoteHead \uN g'16\rest[ d8._-\f\downbow_\markup{\line{"[g]"}\draw-line#'(39 . 0)}] 4 4 16[ a8._-\upbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]}
    \\
    ...
    %316
    \startStaff
    <<\relative c'{\hide NoteHead \uN f4._-\downbow_\markup{\line{"[F]"}\draw-line#'(14 . 0)} \stemDown b8--\upbow_\markup{\line{"[S]"}\draw-line#'(8 . 0)}
    \tuplet 3/2{8 \stemNeutral ds,4_\markup{\line{"[F]"}\draw-line#'(10 . 0)}\downbow_-} 16. cs32_-\upbow_\markup{\line{"[F]"}\draw-line#'(8 . 0)} 8
    \slurDown \tuplet 6/4{\dalniente c16:64\>_\markup{\line{"[R]"}\draw-line#'(12 . 0)} d16:64( e16:64 fs16:64 gs16:64 as16:64)} g4\rest\!
    g4\rest g8.\rest[ e16_-\downbow_\markup{\line{"[F]"}\draw-line#'(17 . 0)}] 4 16[ g8.\rest]
    }
    \\
    ...
    %\break
    %321
    \uN \lineDashed b,16:64\f_-\-\downbow_\markup{\line{"[R]"}\draw-line#'(2 . 0)}[ g'8.\rest]
    ...
    s2
    \startStaff
    <<\relative c'{g'8\rest[ \hide NoteHead \uN f8_-\downbow_\markup{\line{"[F]"}\draw-line#'(27 . 0)}] 4
    8[ 32 a16._-\upbow_\markup{\line{"[S]"}\draw-line#'(8 . 0)}] 32[ g16.\rest g8\rest] }
    \\
    \relative c'{\hide Stem \uN s8 f8\- s4 
    s8 s32 a16.\- s32 g16\rest s32 s8}>>
    \stopStaff s2
    \startStaff 
    r4 r16[ \uN cs,8._-\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}\-]
    \stopStaff \hide Rest r2^\markup{\teeny \box \bold{"reed ON"}}
    \undo \hide Rest
    s2
    \startStaff
    %353
    <<\relative c'{\hide NoteHead \noireNH \sharpUp cs4_- 4
    ...
    \startStaff
    %357
    <<\relative c'{r16.[ \hide NoteHead \uN cs32_-\downbow_\markup{\line{"[F]"}\draw-line#'(10 . 0)} 8] 8[ a'_-\upbow_\markup{\line{"[S]"}\draw-line#'(8 . 0)}]
    g8\rest b,8_-\upbow_\markup{\line{"[g]"}\draw-line#'(15 . 0)} 8[ 32 a'16._-\downbow_\markup{\line{"[F]"}\draw-line#'(8 . 0)}]
    \tuplet 5/4{a16[ g16\rest g16\rest fs8_-\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]} \tuplet 5/4{16[ g16\rest g16\rest d8]_-\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}}
    \tuplet 5/4{16[ g16\rest g16\rest g16\rest d_-\upbow_\markup{\line{"[S]"}\draw-line#'(5 . 0)}]} 16[ b'8._-\p\downbow_\markup{\line{"[F]"}\draw-line#'(9 . 0)}]
    %361
    g4\rest g8\rest[ a_-\downbow_\markup{\line{"[F]"}\draw-line#'(15 . 0)}] 
    8.[ b,16_-\downbow_\markup{\line{"[F]"}\draw-line#'(4 . 0)}] \tuplet 5/4{b16[ g'16\rest g16\rest fs8_-]_\markup{\line{"[F]"}\draw-line#'(11 . 0)}}\downbow
    \tuplet 5/4{f8[ g16\rest g16\rest f16_-\downbow_\markup{\line{"[F]"}\draw-line#'(11 . 0)}]} \tuplet 5/4{8[ g16\rest g16\rest d16_-_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]}\downbow
    8.[ g16\rest] g4\rest
    %365
    g8\rest[ b,8:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(13 . 0)}] \tuplet 3/2{b8:32[ g'8\rest g\rest]} 
    g16\rest[ cs,8:32_-\upbow_\markup{\line{"[R]"}\draw-line#'(8 . 0)} g'16\rest] \tuplet 3/2{g8\rest[ g\rest cs,8:32_-\upbow_\markup{\line{"[R]"}\draw-line#'(5 . 0)}]}
    c16:32[ a'8._-\downbow_\markup{\line{"[F]"}\draw-line#'(63 . 0)}] a4
    4 4 
    ...
    \stopStaff s2*2
    \startStaff 
    <<\relative c'{ \hide NoteHead \tuplet 3/2{ \noireNH \sharpUp b'8\rest cs,4_-^\markup{\teeny{"sotto voce"}}\ppp} 4
    c4 4 
    4 8[ g'\rest^\markup{\teeny \box \bold{"reed OFF"}}]
    \stopStaff s2*3
    \startStaff 
    g4\rest \uN g16\rest[ fs8._-\downbow_\markup{\line{"[F]"}\draw-line#'(17 . 0)}]
    f8. a16_-\downbow_\markup{\line{"[g]"}\draw-line#'(5 . 0)} 16[ b,8.]_-\upbow_\markup{\line{"[F]"}\draw-line#'(35 . 0)}
    4 4
    8.[ g'16\rest] a4_-\downbow_\markup{\line{"[F]"}\draw-line#'(15 . 0)}
    ...
    g8.\rest fs16_.\f \hide NoteHead \uN fs4_-\downbow_\markup{\line{"[F]"}\draw-line#'(30 . 0)}
    f4 16 cs8._-\downbow_\markup{\line{"[g]"}\draw-line#'(10 . 0)}
    %386
    g'4\rest g16\rest[ b,8._-\downbow_\markup{\line{"[F]"}\draw-line#'(15 . 0)}] 
    g'8\rest[ d8:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(5 . 0)}] g8\rest[ d8_-\downbow_\markup{\line{"[F]"}\draw-line#'(17 . 0)}]
    8[ g8\rest] g4\rest }
    \\
    ...
    %382 
    s16 g8\rest fs16\- \omit TupletBracket \omit TupletNumber \tuplet 3/2{s4 b8\-} s16 \hide Rest r8 s16 \undo \hide Rest s4
    ...
    %408
    \startStaff
    <<\relative c'{\hide NoteHead b4:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(20 . 0)} b4:32}
    \\
    \relative c'{\hide Stem \uN \lineDashed b4\-\fffff s4}>> \stopStaff
    s2 \startStaff r4
    <<\relative c'{\hide NoteHead a'4:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(10 . 0)} a8.:32[ g16\rest]}
    \\
    \relative c'{\hide Stem \uN \lineDashed a'4\-\fffff s8 s16 g16\rest}>> r4
    ...
    <<\relative c'{g'8.\rest[ \hide NoteHead \noireNH b,16:32_-\mp] b8:32[ g'8\rest]}
    \\
    ...
    \undo \hide Rest \startStaff r4  <<\relative c'{ \hide NoteHead aqs'4_-
    a4 16[ g16\rest g8\rest]
    g4\rest g8\rest[ b,8_-]
    4 8[ g'8\rest]}
    \\
    \relative c'{\hide Stem \noireNH aqs'4\-
    s4 s16 g16\rest s8
    ...
    r4 <<\relative c'{\hide NoteHead \uN b4_-\downbow_\markup{\line{"[F]"}\draw-line#'(21 . 0)}
    8. a'16:64_-\upbow_\markup{\line{"[R]"}\draw-line#'(5 . 0)} 16.:64 cs,32_-\downbow_\markup{\line{"[F]"}\draw-line#'(17 . 0)} 8
    c8. g'16\rest}
    \\
    ...
    %492
    \startStaff
    <<\relative c'{\hide NoteHead b4_-\p 16[ g'16\rest g8\rest]^\markup{\teeny \box \bold{"reed OFF"}}
    \stopStaff s2*3 
    \startStaff \uN d4_-\downbow_\markup{\line{"[g]"}\draw-line#'(17 . 0)} 8.[ g16\rest]
    g4\rest g8\rest \undo \hide NoteHead \tuplet 3/2{\slap d16_.\f e_. fs_.}
    \hide NoteHead \uN fs4\downbow_-_\markup{\line{"[F]"}\draw-line#'(21 . 0)} \tuplet 3/2{4 a8\upbow_-_\markup{\line{"[S]"}\draw-line#'(10 . 0)}}
    8[ g8\rest] \undo \hide NoteHead \tuplet 3/2{\slap cs,16_.\f ds_. f_.} g8\rest^\markup{\teeny \box \bold{"reed ON"}}}
    \\
    ...
    \startStaff 
    \noireNH \sharpUp \dalniente  fs4--\mp\> \glissando \magnifyMusic 0.5 {f!32\!} r32 r8.
     <<\relative c{\hide NoteHead \noireNH s8 \hide Stem <a'' b c' e>8 \undo \hide Stem \stemDown 8[ g8\rest^\markup{\teeny \box \bold{"reed OFF"}}]}
    \\
    \relative c{\noireNH r8[ <a'' b c' e>8]\ppp\- s8 \hide Stem  g8\rest }>>
    ...
    \stopStaff s2*13
    \startStaff
    r4 \tuplet 6/4{\slap c16-.\f d-. e-. fs-. gs-. as-.}
    \tuplet 5/4{cs,16-. ds-. f-. g-. a-.} <<\relative c'{\hide NoteHead \uN \stemDown g'16\rest[ b8.\upbow_\markup{\line{"[sh]"}\draw-line#'(5 . 0)}]\mf--
    \tuplet 3/2{8 \stemNeutral cs,4_-\downbow_\markup{\line{"[F]"}\draw-line#'(14 . 0)}} 8[ fs8:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(15 . 0)}]
    f8:32 \undo \hide NoteHead \slap \tuplet 3/2{b,16_. cs_. ds_.} \tuplet 3/2{f16_.[ g_. b16\rest]}
    g8\rest g4\rest g16\rest[ \hide NoteHead \uN b,8.\downbow_-_\markup{\line{"[F]"}\draw-line#'(10 . 0)}] 
    16 a'8._-\upbow_\markup{\line{"[S]"}\draw-line#'(10 . 0)} 16 \undo \hide NoteHead \slap \tuplet 3/2{b,16-.\f cs-. ds-.} g16\rest
    \hide NoteHead \uN e4_-\downbow_\markup{\line{"[F]"}\draw-line#'(18 . 0)} 4
    a4\upbow_-_\markup{\line{"[S]"}\draw-line#'(8 . 0)} cs,8:32\downbow_-_\markup{\line{"[R]"}\draw-line#'(2 . 0)}[ g'8\rest]
    \stopStaff s2*3 
    %540 [30]
    \startStaff cs,4_-\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)} a'4_-\downbow_\markup{\line{"[S]"}\draw-line#'(10 . 0)}
    8.[ fs16_-\upbow_\markup{\line{"[g]"}\draw-line#'(20 . 0)}] 4
    \tuplet 3/2{f4 b,8_-\downbow_\markup{\line{"[F]"}\draw-line#'(22 . 0)}} 4
    8[ a'_-\upbow_\markup{\line{"[sh]"}\draw-line#'(9 . 0)}] 8.[ fs16_-\downbow_\markup{\line{"[F]"}\draw-line#'(15 . 0)}]
    \tuplet 3/2{f2 cs4_-\upbow_\markup{\line{"[g]"}\draw-line#'(15 . 0)}}
    \tuplet 3/2{c4 b8:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(9 . 0)}} b8.:32[ a'16_-\upbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]
    4 8.[ fs16_-\downbow_\markup{\line{"[g]"}\draw-line#'(25 . 0)}]
    f4 8[ g8\rest]}
    \\
...
\relative c'{
  ...
  s2 \startStaff
  <<\relative c'{\hide NoteHead \uN
    b'16\rest[ b8.] 8[ b16_. b16\rest]}
    \\
    \relative c'{\hide Stem 
    b'16\rest \uN b8.\- s8 \uNw b16 b16\rest
  }>>
  s2*5 
  %281
  r4 \uN b8.\-[ \uNw 16] \stopStaff s2*2 \startStaff 
  %284
  \uN b8\-[ \uNw b16-. r16] r4
  \stopStaff s2*3
  %288
  \startStaff <<\relative c''{\hide NoteHead g4\rest g8\rest[ g32\rest b16.]
  16[ 16-. g8\rest] g4\rest \stopStaff s2*27
  \startStaff %317
  b4\rest b16.\rest[ \uN b32 8]
  \uNw 16-.[ b16\rest b8\rest] b4\rest
  b4\rest b8\rest[ b16\rest \uN b16]
  4 \uNw 16-.[ b16\rest b8\rest]
  \stopStaff s2
  \startStaff
  b4 32[ 32-. b16\rest b8\rest]
  \stopStaff s2
  \startStaff b8\rest[ s16 \uN b16] 8[ \uNw 16-. b16\rest]
  ...
  b4\rest b16.\rest[ \uN b32 8] \uNw32[ b16\rest s32 \uN b8] 8[ \uNw 16-. b16\rest]
  ...
  b4\rest b16\rest[ \uN b8.\-]
  \uNw b16[ b16\rest b16\rest \uN b16\-] \uNw b16[ b8.\rest]
  b4\rest b8\rest[ b16\rest s32 \uN b32\-] 
  s8.[ \uNw 16-.] b4\rest
  \stopStaff s2*3 \startStaff
  b4\rest b16\rest[ \uN b8.\-]
  ...
  \stopStaff s2*10
  \startStaff \uN b8.[\- \uNw 16-.] r4 \stopStaff
  s2*23
  %533
  \startStaff
  <<\relative c''{\hide NoteHead b4\rest b16\rest[ \uN b8.] 
  16[ \uNw 16-. b8\rest] b4\rest}
  \\
