...
\relative c{
   ...
   r4 
    ...
    %m30
    s16\pp\! d8.\rest \stopOctava d'4\rest
    }>>
  ...
  \lookup "noteheads.s0petrucci"
    ...
    %240
    \stopStaff
    r4 <<\relative c{\hide NoteHead \tuplet 3/2{d'8\rest d16\fff-> d16-> d16-> d16->} \tuplet 3/2{ d16-> d16-> d16-> d16-> d8\rest}}
    \\
    ...
    <<\relative c'{\hide NoteHead \tuplet 3/2{b'8\rest cs,4_-\p} 4
      ...
      \relative c'{\hide Stem
                        ...
                        \omit TupletNumber
                        \discant "20"
                        \tuplet 3/2{s8 cs4\-^\markup{ \teeny{\box{"smooth transition between registers"}}}} s4
                        s2 
...
\relative c{
    ...
    \\
    %M48
    \relative c{d8\rest s16 \hide Stem \octavaDown \stemUp <f,, a?>16--\-
    %m49
    ...
    %89
    s2*6 \startStaff 
    r8[ \octavaDown \dalniente fs8--\>] \glissando \glissandoSkipOn f!8[ \glissandoSkipOff e16 \stopOctava r16\!] \stopStaff %AQUI
    r16 <<\relative c{ \hide NoteHead \uN \tuplet 6/4{g16->[ g16-> g16-> g16-> g16-> g16-> ]} }
    \\
    \relative c{ \stemDown \uN g4\f\-}>> r8. \startStaff
    <<\relative c'{\hide NoteHead s8. \uN \octavaDown a,,32-> a32-> a32-> a32-> a32-> a32-> g8\rest \stopOctava}
    \\
    ...
    \startStaff 
    %124
    <<\relative c{\hide NoteHead \noireNH f,,2_- 4 c'4\rest}
    \\
    \relative c{\blancheNH \hide Stem \octavaDown fs,,2\ppp\-  %m8 
    ...
    \\
    \relative c{ \undo \hide Stem g8\rest[ \noireNH \octavaDown fs,8\-\mf] s4 s8. \stopOctava g'16\rest }>>
    r4
    ...
    s2*8
    %182
    <<\relative c{d8\rest s16 \hide NoteHead \uN  d32\fff->\- \repeat unfold 5{d32->} d8\rest}
    \\
    ...
    \startStaff
    <<\relative c{\hide NoteHead \noireNH  f,4_-\pppp 8..[ g32\rest] \stemUp a,8.[ r16]}
    \\
    ...
    \stopStaff s2*5
    <<\relative c'{ \hide NoteHead \uN \tuplet 5/4{d16\rest[ d16\rest d16\rest d8_-\f\downbow]} \tuplet 5/4{d16[ d16\rest d16\rest d16\rest d16_-\downbow]}
    ...
    %410
    r4
    <<\relative c'{\hide NoteHead \uN d,32-> \repeat unfold 13{d32->} d16\rest }
    \\
    \relative c'{\uN d,4\-\fffff s8 s16 d16\rest }>> r4
    \stopStaff \hide Rest r2 
    \undo \hide Rest 
    % \stopStaff
    ...
    s2*3
    %446
    \startStaff \blancheNH \octavaDown fs2--\- \stopStaff \hide Rest  r2 \stopOctava
    ...
    \\
    \relative c'{\hide Stem \stemUp s4 fs,,,4_-\-
    s4 s16 d''16\rest s8
    s4. <fs,, a>8_-\-
    s4 s8 d8\rest}>>
    \stopStaff %452
