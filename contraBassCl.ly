...
\relative c{
    ...
    r4 r16 \slap e,-.->\f r8
    %m17
    \uN \once \override DurationLine.style = #'dashed-line gs4:32_-\downbow^\markup{\teeny{"exhale"}}_\markup{\line{"[R]"}\draw-line#'(13 . 0)}\- \f r4 \stopStaff
    ...
    %m28
    \startStaff
    r4 r16[ \slap g'16^\markup{\teeny{"slap"}}-.->\f r8]
    %m29
    r4 r16[ \noireNH \dalniente cs,8.\-\<]
    %m30
    r4\p <<\relative c{\hide NoteHead \tuplet 3/2{g'8\rest[ g8\rest c,!8]} c16[ 16_._> d'8\rest] }
    \\
    \relative c{\omit TupletNumber \hide Stem \once \override TupletBracket.bracket-visibility = ##f \tuplet 3/2{g'8\rest g8\rest \dalniente c,8\-\<} s16 s16\f d'8\rest}>> r4 \stopStaff
    s2
    \startStaff 
    \dalniente cs4\<\- r4\f 
     <<\relative c'{\hide NoteHead
       b'8\rest[ \dalniente \uN b8\<\downbow_\markup{\line{"[F]"}\draw-line#'(15 . 0)}] 16[ \dalniente 8.\f\>]
       \stopStaff \hide Rest r2\! \undo \hide Rest
       }
       \\
       \relative c'{\hide Stem \uN s8 b'8\- s16 s8. \stopStaff %\hide Rest r2 \undo \hide Rest 
     }>>
    \stopStaff
    %m35-36
    s2 \startStaff
    
    \lineDashed \dalniente \noireNH b'4:32\-\< r4\ff \stopStaff s2*7
    %C1
    %45
    \startStaff
    ...
    %48
    \startStaff
    <<\relative c{\hide NoteHead \uN  cs'8.:32_-\downbow[ b'16_-\upbow] 16[ g\rest g\rest \noireNH g,16]
    %m49
    8[ 16 d'\rest]}
    \\
    %m48
    \relative c{\hide Stem \uN \lineDashed cs'8.\fff_\markup{\line{"[R]"}\draw-line#'(5 . 0)}\- b'16\-_\markup{\line{"[sh]"}\draw-line#'(3 . 0)} s16 g\rest g\rest \noireNH \dalniente g,16\-\<
    %m49
    s8 s16 d'\rest\f}>> r4
    %m50 
    ...
    r16 \uN \dalniente \lineDashed gs8.\<_\markup{\line{"[R]"}\draw-line#'(5 . 0)}--\-\downbow 
    %53
    r4\mp r8[ r32 \slap e-.->\f^\markup{\teeny{"slap"}}( \xH a' af] 
    %54
    ...
    %84
    \startStaff
    \slap b16-.->\f[^\markup{\teeny{"slap"}} r16 r8] r4
    %85
    ...
    << \relative c'{ g'8\rest[ \hide NoteHead \noireNH b8_-] 8[ g8\rest] }
       \\
       \relative c'{ s8 \hide Stem \noireNH \naturalDown b'!8\mp\- s8 g8\rest}>>
    %95
    \stopStaff s2 \startStaff
    \tuplet 6/4{\uN \dalniente ds,16:64\f--\>_\markup{\line{"[R]"}\draw-line#'(13 . 0)}( e16:64 fs16:64 gs16:64 as16:64 c16:64)} r4\! \stopStaff
    s2*17
    
    %m2,3
    \startStaff
    r16 \slap cs,16-.->\f^\markup{\teeny{"slap"}} << \relative c{\hide NoteHead cs8  16[ d'8.\rest]  d8.\rest[ \dalniente e,16\<] 16[ \dalniente 8\mp\> d'16\rest\!] }
    \\
    ...
    %134-135
    r4 
    <<\relative c{\hide NoteHead \uN g'8\rest[ gs8:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(10 . 0)}] g16:64[ \slap cs,16_._> g'8\rest]}
    \\
    \relative c{g'8\rest \hide Stem  \uN \lineDashed gs8\-\f s16 \slap cs,16^\markup{\teeny{"slap"}} g'8\rest}>>
    r4
    %136
    r4 \slap cs16-.->[ r16 r8]
    %137
    ...
    %140
    s4 s4 }>>
    <<\relative c'{ \override Stem.length = #10
                   \override NoteHead.no-ledgers = ##f
                   \hide NoteHead 
                   \blancheNH b2:32_- 2:32}
      \\
      \relative c'{ \override NoteHead.no-ledgers = ##f
                  \hide Stem 
                   \blancheNH \lineDashed b2\pp\- s2}>>
    %143-157
    \stopStaff
    ...
    %173
    r16\f[ \uN ef'8.\upbow--_\markup{\line{"[S]"}\draw-line#'(8 . 0)}\-] r4
    %174-181
    \stopStaff
    s2*8
    \startStaff
    %182
    <<\relative c{\hide NoteHead \noireNH r8.[ b'16:32\ppp_-] 8:32[ g'8\rest]}
    \\
    \relative c{\hide Stem \noireNH s8. \lineDashed b'16\- s8 g'8\rest}>>
    %183
    <<\relative c{\hide NoteHead r16[ \slap cs16_._>\f \noireNH cs8:32\ppp] 8:32 \xH \slurDown c!16._._>\f^\markup{"+"}( g''32\flageolet) }
    \\
    ...
    %185
    \startStaff
    <<\relative c{r8.[ \hide NoteHead \uN g'16:32_-\fff\downbow_\markup{\line{"[R]"}\draw-line#'(5 . 0)}] g16:32[ g8.\rest] }
    \\
    ...
    %189
    r4 \noireNH \lineDashed gs'8:32_-\pp\-[ r8]
    %190
    r16[ \slap fs-.->\f r8] r4
    %191
    r8.
    ...
    s2*2
    \startStaff
    r8 r32 \slap cs,,16->-.^\markup{\teeny{"slap"}}( \xH g''32\flageolet) r8[ fs,16->-.(^\markup{\teeny{"+"}} g'16\flageolet)]
    %256-257
    r4 <<\relative c{\hide NoteHead \uN g''8\rest[ gs,8:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(10 . 0)}] g16:32[ g'8.\rest]}
    \\
    ...
    r8[ \slap g,16-.\mp r16] r8[ r32 \uN \lineDashed e16.:64\downbow\mf--\-_\markup{\line{"[R]"}\draw-line#'(4 . 0)} ]
    ...
    %281
    \startStaff
    \slap b,16-.\f[^\markup{\teeny{"slap"}} r8.] r4
    r16[ cs,16->-.\fff r16 \xH c!16->(^\markup{\teeny{"+"}}] g''16)[\flageolet r8.]
    r4 r16[ \dalniente \lineDashed \noireNH fs,8.:32\<\-]
    ...
    \stopStaff s2
    \startStaff r8.[ \noireNH \dalniente b,16\<] b8[ g'8\rest\fff]}
    \\
    ...
    %359
    \hide NoteHead
    \tuplet 5/4{g'16\rest[ g16\rest g16\rest gs,8_-\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]} \tuplet 5/4{16[ g16\rest g16\rest e8]_-\downbow_\markup{\line{"[F]"}\draw-line#'(5 . 0)}}
    ...
    \tuplet 3/2{f8 b4\upbow_-_\markup{\line{"[sh]"}\draw-line#'(10 . 0)}} \tuplet 5/4{16[ g16\rest g16\rest gs,8\downbow_-]_\markup{\line{"[F]"}\draw-line#'(13 . 0)}}
    \tuplet 5/4{g8[ g16\rest g16\rest gs16_-\downbow_\markup{\line{"[F]"}\draw-line#'(15 . 0)}]} \tuplet 5/4{8[ g16\rest g16\rest e16_\markup{\line{"[F]"}\draw-line#'(5 . 0)}]}_-\downbow
    16[ g8.\rest] g'4\rest
    %365
    \noireNH
    g8\rest[ g,8:32_-] \tuplet 3/2{g8:32[ g8\rest g\rest]} 
    g16\rest[ g8:32_- g16\rest] \tuplet 3/2{d'8\rest[ d\rest b8:32_-]}
    c16:32[ g'8.\rest]
    }
    \\
   ...
   %{ r4 <<\relative c' { g'16\rest  \diamondH \override NoteHead.no-ledgers = ##t \stemDown \omit Flag \override Stem.length = #25 <e'' f>8.\-}
    ...
    %408 
    \startStaff
    <<\relative c'{\hide NoteHead \uN cs,4:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(20 . 0)} cs4:32}
    \\
    \relative c'{\hide Stem \uN \lineDashed cs,4\-\fffff s4}>> \stopStaff s2
    \startStaff r4
    <<\relative c'{\hide NoteHead \uN cs,4:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(10 . 0)} c8.:32[ g'16\rest]}
    \\
    \relative c'{\hide Stem \uN \lineDashed cs,4\-\fffff s8 s16 g'\rest}>> r4
    \stopStaff
    s2*22
    \startStaff 
    %434
    ...
    \tuplet 3/2{b8\rest \uN \stemNeutral g,4:32_-\downbow_\markup{\line{"[R]"}\draw-line#'(11 . 0)}\f} 16[ b16\rest b8\rest]}
    \\
    \relative c'{s4 \uN   \noireNH <cs a''>4\- 
    ...
    <<\relative c' {\diamondH 
                    ...
                    \stemDown 
                    \omit Flag 
                    \once \override Stem.length = #25 <e'' f>2\-}
    \\
    \relative c' {\blancheNH g2\-\pp}>> \stopStaff \hide Rest r2 \undo \hide Rest
    \startStaff %448
    r4 <<\relative c' {\diamondH \override NoteHead.no-ledgers = ##t 
                       \stemDown 
    ...
    s4 s8 b,8\rest}
    \\
    \relative c' {\noireNH \hide Stem  \stemNeutral g4\-\pp
    s4 s16 \hide Rest r8 s16 \undo \hide Rest
    b'4\rest b8\rest \stemDown g,8\- 
    s4 s8 b'8\rest }
    \\
    ...
    \stopStaff s2*4
    \startStaff  
    <<\relative c'{\sharpUp \dalniente \blancheNH gs2_-\<\- 
                   \hide NoteHead
      g'8\rest[\fff \noireNH \sharpDown cs,8_-] 8[ g'8\rest]
      }
      \\
      \relative c'{s2 \hide Stem \noireNH
    s8 \sharpDown \stemUp cs8\mp\- s8 g'8\rest}>>
    r4 r8.[ \slap cs,,16-.->\fff^\markup{\teeny{"slap"}}]
    \stopStaff 
    %515
    ...
    %529
    \startStaff r4 \noireNH \sharpUp gs'4\glissando--\p 
