...
\relative c{
    ...
    \\
    \relative c{\stemUp \dalniente <c, d'\harmonic>8\-\<^\markup{\teeny{"legno/crine"}} \hide Stem \dalniente s8 s8\mp\> s8 r8\!}>>
    ...
    \startStaff
    r4 <<\relative c{
      r16 \hide NoteHead \uN b8.^\markup{\teeny{"s.t"}} 
    %m46 
    ...
    \\
    \relative c{
      s16 \hide Stem \uN b8.\-^\markup{\teeny  \hspace#-2. \box \teeny{"pitch filtered sound (like air)"}}
    %m46
    ...
    \\
    %79
    \relative c{ \hide Stem \diamondH <d b'>4\- 
    %80
    \omit TupletBracket \omit TupletNumber \tuplet 3/2{s8 <b fs'>4\-} s8 s16 d\rest}>>
    %81
    \stopStaff
    s2*3
    %84
    ...
    %135
    \startStaff
    r16[ \diamondH fs8.-.\p^\markup{\teeny{"pizz."}}\laissezVibrer] r4
    %136
    r4 <a cs>8\p-.\laissezVibrer r8
    %137
    <<\relative c{\diamondH b8-.^\markup{\teeny{"pizz."}}\laissezVibrer}
    \\
    \relative c{\stemUp \omit Flag \noireNH c,8\p\laissezVibrer}>>
    r8 r4
    %138
    \diamondH <d, a'>2\-\pp^\markup{\teeny{"bowing slowly(as slowly as possible)"}}
    %139
    ...
    %170-171
    r4 
    <<\relative c{\hide NoteHead \diamondH \stemDown d'4:32^\markup{\teeny{"crine, tremolo alla punta(serratissimo)"}} d4:32}
    \\
    \relative c{\hide Stem \diamondH \lineDashed d'4\ppppp\- s4}>>
    b,8^\markup{\teeny{"pizz."}}\laissezVibrer[ r8]
    %172
    r4 \clef treble \lineDashed \uN d''4\pp--\-
    %173
     \stopStaff \hide Rest r2
    %174-178
    s2*5
    ...
    \clef bass
    <<
    \relative c{\hide NoteHead \stemUp \once \override NoteColumn.force-hshift = #0.5 <c, b'>2^\markup{\teeny{"crine/legno (hyper slow bowing)"}} 2 2 16[ \diamondH fs'8.:32^\markup{\teeny{"tremolo alla punta(serratissimo)"}}]}
    \\
    \relative c{ \hide Stem \blancheNH \once \override NoteColumn.force-hshift = #0.5 c,2\-\pp s2 s2 s16 \diamondH \lineDashed fs'8.\-}
    \\
    \relative c{ \hide Stem \diamondH \once \override NoteColumn.force-hshift = #0.5 b2\- s2 s2 s16 \hide NoteHead \diamondH fs'8 s16}
    \\
    \relative c{s2 s2 s4}
    >>
    r4
    ...
    \diamondH \dalniente fs,,8.\-\<^\markup{\teeny{"crine"}}[ r16\mf]
    %187-188
    r4 <<\relative c{\hide NoteHead \diamondH \stemDown \tupletDown \tuplet 3/2{r8[ r8 cs'8--^\markup{\teeny{"legno/crine"}}]} c16 <b, fs'>8.--}
    \\
    \relative c{\hide Stem \diamondH \omit TupletNumber \omit TupletBracket \tuplet 3/2{ s8 s8 cs'8\-\mp} s16 <b, fs'>8\- s16}>>
    r4
    %189
    r4 \diamondH a'8--\-\mp[ r8]
    %190
    \clef treble 
    <<
    ...
    \\
    \relative c{g''8\rest s16 \hide Stem \uN \lineDashed cs16\p\- s4 s16 g16\rest s8}>>
    \stopStaff
    s2*2
    \startStaff
    %259
    ...
    \\
    \relative c{g'8\rest \diamondH \hide Stem g8\-\mp s8 g8\rest 
    s8. fs16\- s8 g\rest }>>
    \stopStaff
    s2%262
    \startStaff
    ...
    \\
    \relative c'{\repeat unfold 2{\hide Stem \uN g'8\rest \lineDashed cs8\-}}>>
    %263
    ...
    \\
    \relative c{\hide Stem \diamondH a'8.\- a16\- \omit TupletBracket \omit TupletNumber \tuplet 3/2{s16 fs8\-} s8}>>
    \stopStaff s2*2
    ...
    \stopStaff s2*2
    %350
    \startStaff \dalniente d'8.\<\laissezVibrer^\markup{\teeny{"crine"}}[ r16\f] r4
    \stopStaff s2*2
    \startStaff \noireNH c,,8\p\laissezVibrer^\markup{\teeny{"pizz."}}[ r8] r4
    \stopStaff s2
    \startStaff
    %355
    r4 <<\relative c'{\hide NoteHead \diamondH \stemDown d4^\markup{\teeny{"crine"}}
    16[ g,8.\rest] \dalniente \stemNeutral d,8\<[ g8\rest\f]
    ...
    \tuplet 5/4{16[ d16\rest d16\rest d16\rest b16_-]} \tuplet 3/2{16 d16\rest cs4}
    %361
    d4\rest \clef treble b''8.\rest[ d16] 
    %362
    8 b\rest \clef bass \tuplet 5/4{d,,16\rest[ d16\rest d16\rest fs8]}
    ...
    s16 g,8\rest s16 \noireNH d,8\- g\rest
    s8. \uN fs'16\- s16 \stemUp a,8\- s16
    ...
    \stopStaff s2
    %369
    \startStaff \clef bass r8[ \diamondH \dalniente d''\-\<^\markup{\teeny{"legno/crine"}}] r4\mp
    <a cs>8.\mp\-^\markup{\teeny{"legno/crine"}}[ r16] r8[ b,8\p^\markup{\teeny{"pizz."}}\laissezVibrer-.]
    <<\relative c'{\hide NoteHead \diamondH \stemDown d,16\rest[ fs8.^\markup{\teeny{"legno tratto"}}] 16[ d16\rest d8\rest]}
    \\
    \relative c'{\hide Stem \diamondH s16 fs,8\- s16 s16 d16\rest s8}>>
    ...
    b,4\rest}
    \\
    \relative c'{\hide Stem \omit TupletBracket \omit TupletNumber \tuplet 3/2{ \diamondH s8 cs4\-} s8 s16 g16\rest
    ...
    r4 <<\relative c'{\diamondH \hide NoteHead \dalniente \stemDown d4\<\p^\markup{\teeny{"crine"}}
    ...
    \\
    \relative c'{d,8\rest s16 \hide Stem \diamondH \stemDown fs16\- s4 
    s16 a8\- s16 s4 
    s8 d,8}>> r4
    %385
    r4 r16[ b,8.\p^\markup{\teeny{"legno/crine"}}\-]
    r4 <<\relative c'{d,16\rest[ \diamondH b8.\-]}
    \\
    \relative c'{ d,16\rest \noireNH \hide Flag \stemUp c,8._-\-}>>
    \clef treble r8[ \uN \lineDashed a''8\-\mp] <<\relative c'{\stemDown b'8\rest[  \hide NoteHead fs'8] 
    f8[ b,8\rest]}
    \\
    ...
    \\
    \relative c'{ d,16\rest \noireNH \hide Flag \stemUp c,8._-\laissezVibrer}>> r4 
    %435
    \clef treble <<\relative c'{\stemDown b'8.\rest[ \hide NoteHead \uN c16] 8[ b8\rest]}
    \\
    \relative c'{\hide Stem s8. \lineDashed \uN c'16\-\p s8 b8\rest}>>
    ...
    %446 [27]
    \startStaff
    <<\relative c{ \diamondH b2\- \stopStaff \hide Rest r2 \undo \hide Rest
    \startStaff d4\rest b4\- 
    s4 s16 d16\rest s8
    d4\rest d8\rest \hide NoteHead <b a'>8
    4 8[ d8\rest]}
    \\
    \relative c{\blancheNH \hide Flag \stemUp c,2_-\-
    \stopStaff \hide Rest r2 \undo \hide Rest 
    s4 c4\-
    s4 s16 d'16\rest s8
    s4 s8 \diamondH <b a'>8\- 
    s4 s8 d8\rest}
    \\
    ...
    \\
    \relative c'{\hide Stem \diamondH d,4\- s4
    s8. \uN a16\- s16 d8\rest s16}>>
    \stopStaff s2
    ...
    s2*2
    %507
    \startStaff r4 <<\relative c'{\hide NoteHead \stemDown \diamondH \flatUp df,4\p
    d4 4
    d4 d4\rest}
    \\
    ...
    s2*19
    \startStaff 
    r4 \diamondH a'8\p^\markup{\teeny{"pizz."}}-.\laissezVibrer[ r8]
    \stopStaff s2
    \startStaff \noireNH d,,8..->-.\glissando^\markup{\teeny{"pizz."}} \magnifyMusic0.5{c32} r4
    ...
    %540
    \startStaff
    <<\relative c'{\hide NoteHead \uN a,4^\markup{\teeny{"crine"}} 8.[ fs'16]
    \stemDown f4 \stemNeutral 8[ cs8]
    c4 16[ b'8.]
    4 16[ a,8.]
    \tuplet 3/2{4 cs8} 4
    c16[ fs8.] 4
    \tuplet 3/2{b,4 \uNw \stemDown a'2}
    4 8[ d,8\rest]}
    \\
